...
public class QiuduiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public QiuduiLiuyanEntity() {

	}

	public QiuduiLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "qiudui_liuyan_text")

    private String qiuduiLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getQiuduiLiuyanText() {
        return qiuduiLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setQiuduiLiuyanText(String qiuduiLiuyanText) {
        this.qiuduiLiuyanText = qiuduiLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "QiuduiLiuyan{" +
            ...
            ", qiuduiId=" + qiuduiId +
            ", yonghuId=" + yonghuId +
            ", qiuduiLiuyanText=" + qiuduiLiuyanText +
