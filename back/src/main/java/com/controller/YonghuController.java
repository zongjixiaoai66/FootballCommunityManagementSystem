    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(false)
            ...
            JiaolianEntity jiaolianEntity = jiaolianService.selectById((Integer)request.getSession().getAttribute("userId"));
            if(jiaolianEntity ==null){
                return R.error("当前登录人为教练,但是查不到账户信息");
            }
            params.put("qiuduiId",jiaolianEntity.getQiuduiId());
        }
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表 球队
            //级联表
            QiuduiEntity qiudui = qiuduiService.selectById(yonghu.getQiuduiId());
            if(qiudui != null){
...
//                            yonghuEntity.setQiuduiId(Integer.valueOf(data.get(0)));   //球队 要改的
