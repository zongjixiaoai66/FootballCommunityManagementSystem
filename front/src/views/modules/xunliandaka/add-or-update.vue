    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="训练打卡编号" prop="xunliandakaUuidNumber">
                       <el-input v-model="ruleForm.xunliandakaUuidNumber"
                                 placeholder="训练打卡编号" clearable  :readonly="ro.xunliandakaUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="训练打卡编号" prop="xunliandakaUuidNumber">
                           <el-input v-model="ruleForm.xunliandakaUuidNumber"
                                     placeholder="训练打卡编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="训练标题" prop="xunliandakaName">
                       <el-input v-model="ruleForm.xunliandakaName"
                                 placeholder="训练标题" clearable  :readonly="ro.xunliandakaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="训练标题" prop="xunliandakaName">
                           <el-input v-model="ruleForm.xunliandakaName"
                                     placeholder="训练标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="训练地点" prop="xunliandakaAddress">
                       <el-input v-model="ruleForm.xunliandakaAddress"
                                 placeholder="训练地点" clearable  :readonly="ro.xunliandakaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="训练地点" prop="xunliandakaAddress">
                           <el-input v-model="ruleForm.xunliandakaAddress"
                                     placeholder="训练地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="训练类型" prop="xunliandakaTypes">
                        <el-select v-model="ruleForm.xunliandakaTypes" :disabled="ro.xunliandakaTypes" placeholder="请选择训练类型">
                            <el-option
                                v-for="(item,index) in xunliandakaTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="训练类型" prop="xunliandakaValue">
                        <el-input v-model="ruleForm.xunliandakaValue"
                            placeholder="训练类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="训练日期" prop="xunlianTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xunlianTime" label="训练日期" prop="xunlianTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="训练内容" prop="xunliandakaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xunliandakaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xunliandakaContent" label="训练内容" prop="xunliandakaContent">
                            <span v-html="ruleForm.xunliandakaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否打卡" prop="dakaTypes">
                        <el-select v-model="ruleForm.dakaTypes" :disabled="ro.dakaTypes" placeholder="请选择是否打卡">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="是否打卡" prop="dakaValue">
                        <el-input v-model="ruleForm.dakaValue"
                            placeholder="是否打卡" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    jiaolianId: false,
                    yonghuId: false,
                    xunliandakaUuidNumber: false,
                    xunliandakaName: false,
                    xunliandakaAddress: false,
                    xunliandakaTypes: false,
                    xunlianTime: false,
                    xunliandakaContent: false,
                    insertTime: false,
                    dakaTypes: false,
                },
                ruleForm: {
                    jiaolianId: '',
                    yonghuId: '',
                    xunliandakaUuidNumber: new Date().getTime(),
                    xunliandakaName: '',
                    xunliandakaAddress: '',
                    xunliandakaTypes: '',
                    xunlianTime: '',
                ...
                rules: {
                   ...
                   xunliandakaUuidNumber: [
                              { required: true, message: '训练打卡编号不能为空', trigger: 'blur' },
                          ],
                   xunliandakaName: [
                              { required: true, message: '训练标题不能为空', trigger: 'blur' },
                          ],
                   xunliandakaAddress: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xunliandaka_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xunliandakaTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xunliandakaContent = _this.ruleForm.xunliandakaContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xunliandakaContent = this.ruleForm.xunliandakaContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`xunliandaka/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xunliandakaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
