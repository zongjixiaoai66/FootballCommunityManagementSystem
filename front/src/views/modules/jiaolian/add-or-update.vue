    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='qiudui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="主场" prop="qiuduiAddress">
                        <el-input v-model="qiuduiForm.qiuduiAddress"
                                  placeholder="主场" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='qiudui' ">
                    <el-form-item class="input" v-if="type!='info'"  label="分区" prop="fenquValue">
                        <el-input v-model="qiuduiForm.fenquValue"
                                  placeholder="分区" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
