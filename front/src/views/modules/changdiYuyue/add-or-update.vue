    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='changdi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="场地位置" prop="changdiAddress">
                        <el-input v-model="changdiForm.changdiAddress"
                                  placeholder="场地位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="场地位置" prop="changdiAddress">
                            <el-input v-model="ruleForm.changdiAddress"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约理由" prop="changdiYuyueText">
                        <el-input type="textarea"  :readonly="ro.changdiYuyueText" v-model="ruleForm.changdiYuyueText" placeholder="预约理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.changdiYuyueText" label="预约理由" prop="changdiYuyueText">
                            <span v-html="ruleForm.changdiYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约日期" prop="changdiYuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.changdiYuyueTime" label="预约日期" prop="changdiYuyueTime">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.changdiYuyueShenheTime" label="审核时间" prop="changdiYuyueShenheTime">
                        <span v-html="ruleForm.changdiYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    changdiYuyueUuidNumber: false,
                    changdiId: false,
                    yonghuId: false,
                    changdiYuyueText: false,
                    changdiYuyueTime: false,
                    insertTime: false,
                    changdiYuyueYesnoTypes: false,
                    changdiYuyueYesnoText: false,
                    changdiYuyueShenheTime: false,
                },
                ruleForm: {
