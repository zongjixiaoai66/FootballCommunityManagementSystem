        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zuqiushequguanlixitong/upload/changdiYuyueMuBan.xls"
                        >批量导入场地预约数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('changdiYuyue','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="changdiYuyueText"
                                      header-align="center"
                                      label="预约理由">
                        <template slot-scope="scope">
                            <span v-if="scope.row.changdiYuyueText != null &&scope.row.changdiYuyueText.length>10">
                                {{scope.row.changdiYuyueText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.changdiYuyueText}}
                            </span>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="changdiYuyueShenheTime"
                                   header-align="center"
                                   label="审核时间">
                        <template slot-scope="scope">
                            {{scope.row.changdiYuyueShenheTime}}
                        </template>
                    </el-table-column>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '预约理由': "changdiYuyueText",
                     '预约日期': "changdiYuyueTime",
                     '申请时间': "insertTime",
                     '预约状态': "changdiYuyueYesnoValue",
                     '审核回复': "changdiYuyueYesnoText",
                     '审核时间': "changdiYuyueShenheTime",
            },
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        // types : 'changdi_yuyue_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
