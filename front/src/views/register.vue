    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">足球社区管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                       ...
                       <!--<el-form-item class="select" label="球队">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.qiuduiId" placeholder="请选择球队">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //// 教练 的 球队
                            // if((!this.ruleForm.qiuduiId)&& 'jiaolian'==this.tableName){
                            //     this.$message.error('球队不能为空');
                            //     return
                            // }
                            ...
                            // }
                            //// 用户 的 球队
                            // if((!this.ruleForm.qiuduiId)&& 'yonghu'==this.tableName){
                            //     this.$message.error('球队不能为空');
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/zuqiushequguanlixitong/img/back-img-bg.jpg);
